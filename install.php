...
rex_sql_table::get(rex::getTable('feeds_item'))
    ...
    ->ensureColumn(new rex_sql_column('title', 'text', true))
    ...
    ->ensureColumn(new rex_sql_column('date', 'datetime', false, null, 'on update CURRENT_TIMESTAMP'))
    ...
    rex_sql_table::get(rex::getTable('feeds_stream'))
    ->ensureForeignKey(new rex_sql_foreign_key('rex_feeds_stream_ibfk_1', rex::getTable('feeds_item'), ['id' => 'stream_id'], rex_sql_foreign_key::CASCADE))
    ->ensure();
